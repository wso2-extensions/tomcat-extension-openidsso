...
public class TestConstants {
    ...
    public static final String NO_WEB_APP = "no";
    private static final String SSL_PROTOCOL = "https";
    private static final int SSL_PORT = 8443;
    private static final String DEFAULT_TOMCAT_HOST = "localhost";
    ...
    public static final String INVALID_SCOPE = "profile";
    ...
    public static final String INVALID_AUTHENTICATION_RESPONSE_URL = DEFAULT_TOMCAT_HOST + ":" +
            SSL_PORT + "/" + SAMPLE_WEB_APP + "/openid";
    public static final String SAMPLE_STRING = "abckjacdcdkjnascs";
